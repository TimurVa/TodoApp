...
namespace ToDoApp.Helpers
{
    public static class Static
    {
        ...
        static string _databaseName = "appdb.db";
        static string _folder = System.Environment.GetFolderPath(System.Environment.SpecialFolder.MyDocuments);

        /// <summary>
        /// Connection string for SQLite database
        /// </summary>
        public static string DatabasePath { get; } = "DataSource=" + System.IO.Path.Combine(_folder, _databaseName);
        ...
        public const string KEY = "braveheart";
